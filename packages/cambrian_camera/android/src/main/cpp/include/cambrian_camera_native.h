...
enum class SinkRole {
    ...
    RAW,       ///< receives passthrough (pre-color-processing) RGBA at naturalStreamHeight
};
...
public:
    ...
    ///   - SinkRole::RAW      — receives passthrough RGBA at naturalStreamHeight via deliverRawRgba().
